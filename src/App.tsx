  ...
  <div className="group flex flex-col h-full bg-neutral-100/10 border border-neutral-200 dark:text-white rounded-xl dark:bg-neutral-800/10 dark:border-neutral-800">
    ...
    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-6 border-t border-neutral-600/20">
      ...
      <a href='https://audity.w3bots.de' target='_blank'>
        <button className='bg-green-300 font-medium text-neutral-900 px-3 py-1 rounded-lg'>Start Demo</button>
      </a>) : (
        <Badge>
          {status}
        </Badge>
  ...
  const team = {
    ...
    ? [
      {
        name: "Mike Tsakonas",
        role: "CEO",
        description: "Treibende Kraft hinter der operativen Strategie und Umsetzung mit Fokus auf Web3-Innovation. Bringt eine starke Basis in der Produktentwicklung, kreativer Content-Produktion und Projektmanagement mit, um Teams zu führen und wirkungsvolle Ergebnisse in aufstrebenden Technologien zu liefern.",
        photo: mikeTsakonasPhoto
      },
      {
        name: "Patrick Knobloch",
        role: "COO",
        description: "Leitet die Entwicklung von Blockchain-, App- und Webprojekten mit Schwerpunkt auf UI/UX-Design. Verbindet technisches Fachwissen mit nutzerorientiertem Denken, um sichere, skalierbare und intuitive Web3-Lösungen zu schaffen, die Innovation und Zugänglichkeit verbinden.",
    ...
    : [
        
        {
          name: "Mike Tsakonas",
          role: "CEO",
          description: "Driving operational strategy and execution with a focus on Web3 innovation. Brings a strong foundation in product development, creative content production, and project management to lead teams and deliver impactful results in emerging technologies.",
          photo: mikeTsakonasPhoto
        },
        {
          name: "Patrick Knobloch",
          role: "COO",
          description: "Orchestrating blockchain, app, and web development with a focus on UI/UX design. Combines technical expertise with user-first thinking to create secure, scalable, and intuitive Web3 solutions that bridge innovation with accessibility.",
          photo: patrickKnoblochPhoto
        },
        {
          name: "Pedro Augusto",
      ...
      <div className="w-full max-w-7xl mx-auto space-y-8 relative z-50">
        ...
        <Card className=" w-full border-none shadow-none p-3 md:px-6 py-3 md:py-6">
          ...
          <CardContent className='text-center w-full md:w-2/3  mx-auto opacity-80 text-base'>
            ...
            <div className='mt-6'>
            {language === 'de' ? 
          "Vielen Dank für die Prüfung unserer Bewerbung. Wir sind begeistert von der Möglichkeit, Teil der Techstars-Community zu werden, um gemeinsam die Grenzen des Machbaren zu verschieben und eine noch innovativere Zukunft zu gestalten."
          : 
"Thank you for reviewing our application. We are thrilled about the opportunity to become part of the Techstars community, to push the boundaries of what’s possible, and to shape an even more innovative future together."
      ...
      <footer className=" mt-auto w-full max-w-[85rem] py-10 px-8 sm:px-6 lg:px-8 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 mb-10">
          ...
          <svg className='w-full pr-8 dark:fill-white fill-neutral-900' viewBox="0 0 4346 1023" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
            <clipPath id="clip0_1446_118">
            <rect width="4346" height="1023" className='dark:fill-white fill-neutral-900'/>
            </clipPath>
            </defs>
          </svg>
          </a>
